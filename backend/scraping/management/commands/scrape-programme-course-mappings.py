...
class Command(BaseCommand):
    ...
    def get_programme_codes(self, year, sem):
        ...
        with urllib.request.urlopen(req) as response:
            ...
            codes = [[programme.attrs['value'], programme.next.strip()] for programme in programmes if programme.attrs['value']]
        return codes
    ...
    def handle(self, *args, **options):
        ...
        for term in self.terms:
            ...
            for code in programme_codes[-92:]:
                # Modify code in course_url_values
                self.course_url_values['r_course_yr'] = code[0]
