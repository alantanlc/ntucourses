...
export class CourseDetail extends Component {
    ...
    componentDidMount() {
        axios.get(`https://ntucoursesprod.df.r.appspot.com/courses/${this.props.match.params.course_code}/`) // need to include a forward slash at the end to avoid double api call
            .then(res => {
